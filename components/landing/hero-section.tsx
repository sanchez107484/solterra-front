...
export function HeroSection() {
    ...
    return (
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden py-8 md:py-12">
            ...
            {/* Floating particles effect - static to avoid CLS */}
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
                {[...Array(6)].map((_, i) => (
                    <div
                        key={i}
                        className="bg-primary/20 absolute h-1.5 w-1.5 rounded-full opacity-40"
                        style={{
            ...
            <button
                ...
                className="hover:text-primary absolute bottom-4 left-1/2 hidden cursor-pointer transition-colors md:bottom-8 md:block"
