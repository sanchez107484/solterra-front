                ...
                <div className="w-full max-w-md">
                    ...
                    <Card className="border-2 p-8 shadow-xl">
                        <div className="mb-8 text-center">
                            ...
                            <h2 className="text-foreground mb-2 text-3xl font-bold">{t?.auth?.promoter?.createAccount}</h2>
                            <p className="text-muted-foreground">{t?.auth?.promoter?.subtitleRegister}</p>
                        </div>
                        ...
                        <div className="mt-6 text-center text-sm">
                            <span className="text-muted-foreground">{t?.auth?.promoter?.haveAccount}</span>{" "}
                            <button onClick={() => router.push("/login/promotor")} className="text-secondary font-semibold hover:underline">
                                {t?.auth?.promoter?.loginButton}
                            </button>
                        </div>
