                                            ...
                                            <div className="flex justify-center">
                                                <div className="relative">
                                                    <Avatar className="h-24 w-24 cursor-pointer" onClick={handleAvatarClick}>
                                                        ...
                                                        />
                                                        <AvatarFallback
                                                            className={`text-lg ${user?.rol === "PROPIETARIO" ? "bg-primary/20 text-primary" : "bg-secondary/20 text-secondary"}`}
                                                        >
                                                    ...
                                                    <Button
                                                        size="sm"
                                                        variant={user?.rol === "PROPIETARIO" ? "default" : "secondary"}
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-3">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-muted-foreground text-sm">
                                                    {user?.creadoEn ? new Date(user.creadoEn).toLocaleDateString("es-ES") : t?.common?.na}
                                                </span>
                                            </div>
                                        </CardContent>
                                    </Card>
                                        ...
                                        <CardContent>
                                            {isLoadingStats ? (
                                                ...
                                                <div className="py-8 text-center">
                                                    ...
                                                    <p className="text-muted-foreground mt-1 text-sm">{t?.profile?.stats?.noDataDesc}</p>
                                                </div>
                                            )}
                                        </CardContent>
                                    </Card>
