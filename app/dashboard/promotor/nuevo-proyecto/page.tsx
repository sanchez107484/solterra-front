                    ...
                    <div className="mb-3 flex items-center justify-between">
                        <Link href="/dashboard/promotor" className="group flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-xs">Marketplace de Energías Renovables</p>
                            </div>
                        </Link>
                            ...
                            {step === 1 && (
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                {Object.entries({
                                                    ...
                                                    <button
                                                        key={key}
                                                        type="button"
                                                        onClick={() => setFormData({ ...formData, tipo: value as TipoProyecto })}
                                                    ...
                                                    >
                                                        <div className="flex items-start gap-4">
                                                            ...
                                                            {formData.tipo === value && <CheckCircle className="text-secondary h-6 w-6" />}
                                                        </div>
                                                    </button>
                                                ))}
                                            </div>
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="potenciaObjetivo" className="flex items-center gap-2 text-base font-semibold">
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <p className="text-muted-foreground text-sm">Potencia instalada que planeas desarrollar</p>
                                        </div>
                            ...
                            {step === 2 && (
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="presupuesto" className="flex items-center gap-2 text-base font-semibold">
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <p className="text-muted-foreground text-sm">Inversión total estimada para el proyecto</p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            <div className="space-y-3">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setFormData({ ...formData, distanciaMaximaRed: e.target.value })}
                                                />
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <p className="text-sm">Buscaremos terrenos compatibles en nuestra base de datos</p>
                                                    </div>
                                                </div>
                                                <div className="space-y-3">
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <p className="text-sm">Te notificaremos cuando encontremos coincidencias</p>
                                                    </div>
                                                    <div className="flex items-start gap-3">
                                                        <Badge variant="secondary" className="mt-1">
                                                            4
                                                        </Badge>
                                                        <p className="text-sm">Podrás contactar directamente con los propietarios</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
