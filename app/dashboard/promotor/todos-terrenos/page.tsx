        ...
        <ProtectedRoute requiredRole="PROMOTOR" redirectTo="/login/promotor">
            <div className="container mx-auto space-y-8 p-6">
                ...
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Todos los Terrenos</h1>
                        <p className="text-muted-foreground">Encuentra terrenos perfectos para tus proyectos energéticos</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center justify-between">
                            ...
                            <span className="text-muted-foreground text-sm font-normal">{sortedTerrenos.length} terrenos encontrados</span>
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        {isLoading ? (
                                            ...
                                            <TableRow key={terreno.id}>
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span className="text-sm">{terreno.direccion || terreno.provincia || "-"}</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
