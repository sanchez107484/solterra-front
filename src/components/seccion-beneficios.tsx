    ...
    return (
        <section className="py-20 md:py-32">
            <div className="container mx-auto px-4">
                ...
                <div className="mb-20">
                    <h3 className="text-primary mb-8 text-center text-3xl font-bold">{t.benefits.landownerTitle}</h3>
                    <div className="grid gap-6 md:grid-cols-3">
                        {beneficiosPropietarios.map((beneficio, index) => {
                            ...
                            return (
                                <Card
                                    key={index}
                                    className="group border-primary/20 from-primary/5 hover:border-primary relative overflow-hidden bg-gradient-to-br to-transparent p-8 transition-all hover:scale-105 hover:shadow-xl"
                                >
                                    <div className="bg-primary/20 mb-6 inline-flex rounded-2xl p-4">
                                    ...
                                    <div className="bg-primary/10 absolute right-0 bottom-0 h-24 w-24 rounded-tl-full transition-all group-hover:h-32 group-hover:w-32" />
                                </Card>
                            )
                        })}
                    </div>
                ...
                <div>
                    <h3 className="text-secondary mb-8 text-center text-3xl font-bold">{t.benefits.developerTitle}</h3>
                    <div className="grid gap-6 md:grid-cols-3">
                        {beneficiosPromotores.map((beneficio, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h4 className="text-foreground mb-3 text-xl font-bold">{beneficio.title}</h4>
                                    <p className="text-muted-foreground">{beneficio.description}</p>
                                    <div className="bg-secondary/10 absolute right-0 bottom-0 h-24 w-24 rounded-tl-full transition-all group-hover:h-32 group-hover:w-32" />
                                </Card>
                            )
                        })}
                    </div>
